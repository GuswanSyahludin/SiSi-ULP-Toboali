...
- Workspace ID: `3cfd2552-e63b-43c3-adb0-34183868786a`
- An access token starting with `ngpk_`. Provide it via the `NGODINGPAKEAI_TOKEN`
  ...
  Create one at https://www.ngodingpakeai.com/settings (API keys). Synced content is viewable at https://www.ngodingpakeai.com/workspace/3cfd2552-e63b-43c3-adb0-34183868786a.
...
2. `npx ngodingpakeai connect --workspace 3cfd2552-e63b-43c3-adb0-34183868786a --token "$NGODINGPAKEAI_TOKEN"` — link this repo to the workspace (first time only).
...
5. Always report the sync summary and https://www.ngodingpakeai.com/workspace/3cfd2552-e63b-43c3-adb0-34183868786a. Only pass on links the CLI actually printed — never assemble one from an id yourself.

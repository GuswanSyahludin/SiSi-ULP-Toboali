  ...
  return [
    {
      ...
      tim: "Inspeksi",
      subTim: "Inspeksi Jaringan",
      recalc: recalcWaInsJar_,
    },
    {
      label: "Inspeksi Gardu",
      tim: "Inspeksi",
      subTim: "Inspeksi Gardu",
      recalc: recalcRealisasiGarduByHeader,
    },
...
function refreshWaHarian() {
  try {
    ...
    var kemarin = Utilities.formatDate(
    ...
    for (var i = 1; i < data.length; i++) {
      ...
      try {
        b.recalc(ss, String(r[H.kodeHeader]).trim());
        n++;

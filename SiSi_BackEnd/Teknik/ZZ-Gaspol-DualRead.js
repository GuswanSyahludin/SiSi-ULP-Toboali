...
function _gaspolFromInspeksiJar(f) {
  ...
  try {
    ...
    Logger.log("[_gaspolFromInspeksiJar dual] " + e.message);
  }
  return map;
}
...
function _gaspolFromInspeksiGardu(f) {
  ...
  try {
    ...
    Logger.log("[_gaspolFromInspeksiGardu dual] " + e.message);
  }
  return map;
}
...
function _gaspolFromHartek(f) {
  ...
  try {
    ...
    Logger.log("[_gaspolFromHartek dual] " + e.message);
  }
  return map;
}
...
function _gaspolFromYandal(f) {
  ...
  try {
    ...
    Logger.log("[_gaspolFromYandal dual] " + e.message);
  }
  return map;
}

...
class _FormState extends State<InsGarduForm> {
  ...
  Widget build(BuildContext context) => Scaffold(
        ...
        body: ListView(
          padding: const EdgeInsets.all(16),
          children: [
            _field('Koordinat Gardu Awal', a),
            _field('Koordinat Gardu Akhir', b),
            _field('KM Awal', ka),
            _field('KM Akhir', kb),
            _field('Kendala', kendala, lines: 3),
          ],
        ),
                ...
                ...gs.map(
                  (g) => Card(
                    child: ListTile(
                      ...
                      subtitle: Text(g.tier.isEmpty ? 'Belum diisi' : g.tier),
                      onTap: () => Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (_) => InsGarduTemuanEditor(g: g),
                        ),
                      ).then((_) {
                        if (mounted) setState(() {});
                      }),

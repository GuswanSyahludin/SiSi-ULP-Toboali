...
/// Open only after LocalWatermarkRenderer.render succeeds with the final
/// domain ID and frozen capture metadata. This does not render a draft ID.
...
class _PreviewState extends State<LocalWatermarkPreviewScreen> {
  ...
  Future<void> save() async {
    ...
    try {
      ...
      ScaffoldMessenger.of(context).showSnackBar(SnackBar(content: Text(
        saved ? 'Foto ber-watermark disimpan di lokasi pilihan Anda.' : 'Penyimpanan dibatalkan. Foto tetap tersedia di aplikasi.',
      )));
    } catch (e) {
  ...
  @override Widget build(BuildContext context) => PopScope(
    ...
    child: Scaffold(
      ...
      appBar: AppBar(
        backgroundColor: const Color(0xFF152532), foregroundColor: const Color(0xFFF4F8FA),
      ...
      body: Column(children: [
        Expanded(child: InteractiveViewer(
          ...
          child: Center(child: Image.memory(widget.photo.jpeg, fit: BoxFit.contain,
            semanticLabel: 'Foto dengan watermark SiSi',
      ...
      bottomNavigationBar: SafeArea(child: Padding(
        ...
        child: Column(mainAxisSize: MainAxisSize.min, children: [
          const Text('Foto asli tidak diubah. Pilih folder tujuan pada layar berikutnya.', textAlign: TextAlign.center, style: TextStyle(fontSize: 12, color: Color(0xFFB8CCD6))),
          ...
          SizedBox(width: double.infinity, child: FilledButton.icon(
            ...
            label: Text(saving ? 'Menyimpan…' : 'Simpan foto ber-watermark'),
          )),
        ]),
      )),
    ),

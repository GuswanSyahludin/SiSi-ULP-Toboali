...
class _BerandaScreenState extends State<BerandaScreen> {
          ...
          children: [
                ...
                const Expanded(
                  child: Column(
                    ...
                    children: [
                      ...
                      SizedBox(height: 3),
                      Text(
                        'Jadwal pekerjaan dan dampak pelanggan.',
                        style: TextStyle(
            ...
            Row(
              children: [
                ...
                Text(
                  '${_selectedEvents.length} pekerjaan',
                  style: const TextStyle(
                    color: Color(0xFF667085),
                    fontSize: 12,
            ...
            if (_loading) ...List.generate(3, (_) => const _AgendaSkeleton())
              ...
              _state(
                ...
                'Tidak ada pekerjaan',
                'Pilih tanggal bertanda untuk melihat agenda.',
              )
            else
              ..._selectedEvents.map(_agenda),
          ],
        ),
      ),
    );
        ...
        children: [
          Row(
            children: [
              ...
              Expanded(
                child: Column(
                  ...
                  children: [
                    ...
                    const Text(
                      'Semangat pagi, pekerjaan hari ini sudah disiapkan.',
                      style: TextStyle(
                        color: Color(0xFF667085),
                        fontSize: 12,
                      ),
              ...
              const Column(
                children: [
                  Icon(Icons.circle, size: 8, color: AppColors.success700),
                  SizedBox(height: 3),
                  Text(
                    'Online',
                    style: TextStyle(
          ...
          Row(
            children: [
              _fact('Role', '${widget.sesi['role'] ?? '-'}'),
              _divider(),
              _fact('Unit', '${widget.sesi['ulp'] ?? '-'}'),
              _divider(),
              _fact(
                'Tim',
  ...
  Widget _monthButton(IconData icon, VoidCallback action) => SizedBox.square(
        dimension: 40,
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
                ...
                child: Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    border: today && !selected
                        ? Border.all(color: AppColors.navy700, width: 1.4)
                        : null,
                  ),
                  child: Stack(
                    alignment: Alignment.center,
          ...
          const Row(
            children: [
              _Legend(color: AppColors.navy700, label: 'Jadwal Padam'),
              SizedBox(width: 14),
              _Legend(color: AppColors.amber700, label: 'Pekerjaan'),
              SizedBox(width: 14),
              _Legend(color: AppColors.success700, label: 'Selesai'),
            ],
          ),
        ],
      ),
  ...
  Widget _agenda(Map<String, dynamic> item) {
    ...
    final color = status == 'Terealisasi'
          ...
          Expanded(
            child: Column(
              ...
              children: [
                ...
                const SizedBox(height: 4),
                Text(
                  '${item['penyulang'] ?? '-'} • ${item['section'] ?? '-'} • ${item['jumlahPelanggan'] ?? 0} pelanggan',
                  maxLines: 1,
                  overflow: TextOverflow.ellipsis,
                  style: const TextStyle(
                    color: Color(0xFF667085),
  ...
  Widget _state(IconData icon, String title, String message) => Container(
        ...
        child: Column(
          children: [
            Icon(icon, color: const Color(0xFF98A2B3), size: 38),
            const SizedBox(height: 10),
            Text(
              title,
              style: const TextStyle(
...
class _Legend extends StatelessWidget {
  ...
  Widget build(BuildContext context) => Row(
        ...
        children: [
          ...
          Text(label, style: const TextStyle(color: Color(0xFF667085), fontSize: 9)),
        ],
      );
}
...
class _AgendaSkeleton extends StatelessWidget {
  ...
  Widget build(BuildContext context) => Container(
        ...
        child: Row(
          children: [
            Container(width: 42, height: 12, color: const Color(0xFFE7ECF2)),
            const SizedBox(width: 14),
            Expanded(
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  Container(width: 180, height: 12, color: const Color(0xFFE7ECF2)),
                  const SizedBox(height: 10),
                  Container(width: 230, height: 9, color: const Color(0xFFF0F3F7)),
                ],
              ),
            ),
          ],

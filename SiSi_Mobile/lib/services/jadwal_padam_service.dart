...
class JadwalPadamService {
  ...
  static Future<Map<String, dynamic>> master({required String token}) => _post('getMobileJadwalPadamMaster', {'token': token});
  static Future<Map<String, dynamic>> calendar({required String token, required int year, required int month}) => _post('getMobileJadwalPadamCalendar', {'token': token, 'year': year, 'month': month});

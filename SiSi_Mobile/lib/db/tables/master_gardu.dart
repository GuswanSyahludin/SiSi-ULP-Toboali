...
class MasterGardus extends Table {
  ...
  TextColumn get beratTrafo => text().withDefault(const Constant(''))();
  TextColumn get volumeMinyak => text().withDefault(const Constant(''))();
  ...
  TextColumn get arusMaxPerFasa => text().withDefault(const Constant(''))();
  TextColumn get pembebananKva => text().withDefault(const Constant(''))();
  TextColumn get pembebananKw => text().withDefault(const Constant(''))();
  TextColumn get persentaseBeban => text().withDefault(const Constant(''))();
  TextColumn get kategoriBeban => text().withDefault(const Constant(''))();
}
